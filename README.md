...
| 角色 | 担当 | 职责 |
|------|:----:|------|
| 🧑 **Star.Li** | 真人 | CEO/PM/QA/运维/运营/投资人 — 产品方向、需求决策、全平台验收、部署发布、内容宣发、跨 AI 上下文传递 |
| 🏗️ **ChatGPT** | AI | 系统架构师 — 技术选型、数据库设计、API 结构规划、安全审计、方案评估 |
| 💻 **Claude Code + DeepSeek v4 Pro** | AI | 全栈工程师 — 前端 46+ 组件、后端 19 个 API、10 个 Server Action、移动端 25+ 项适配、39 份文档 |

协作流水线：**ChatGPT 出架构 → Star 理解传达 → Claude 写代码 → Star 验收部署**

标准团队 10+ 人的全职能链（产品·开发·测试·运维·安全·文档·宣发），这里 3 个角色全覆盖。不是因为人少，是因为每个人都在做自己最擅长的事，而且**没有内部会议**。

> 详见 [`docs/06-项目记录/00-项目全史.md`](docs/06-项目记录/00-项目全史.md)
